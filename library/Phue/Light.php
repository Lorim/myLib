...
class Phue_Light
{
     ...
     */
    public function __construct($id, \stdClass $attributes, Phue_Client $client)
    {
        $this->id         = (int) $id;
    ...
    public function setName($name)
    {
        $this->client->sendCommand(
            new Phue_Command_SetLightName($this, (string) $name)
        );
    ...
    {
        return Phue_LightModel_LightModelFactory::build($this->getModelId());
    }
    ...
    {
        $this->client->sendCommand(
            (new Phue_Command_SetLightState($this))->on((bool) $flag)
        );
     ...
     * @return Light Self object
     */
    public function setAlert($mode = Phue_Command_SetLightState::ALERT_LONG_SELECT)
    {
        $this->client->sendCommand(
            (new Phue_Command_SetLightState($this))->alert($mode)
        );
     ...
     * @return Light Self object
     */
    public function setEffect($mode = Phue_Command_SetLightState::EFFECT_NONE)
    {
        $this->client->sendCommand(
            (new Phue_Command_SetLightState($this))->effect($mode)
        );
     ...
     * @return Light Self object
     */
    public function setBrightness($level = Phue_Command_SetLightState::BRIGHTNESS_MAX)
    {
        $this->client->sendCommand(
            (new Phue_Command_SetLightState($this))->brightness((int) $level)
        );
    ...
    {
        $this->client->sendCommand(
            (new Phue_Command_SetLightState($this))->hue((int) $value)
        );
    ...
    {
        $this->client->sendCommand(
            (new Phue_Command_SetLightState($this))->saturation((int) $value)
        );
    ...
    {
        $this->client->sendCommand(
            (new Phue_Command_SetLightState($this))->xy((float) $x, (float) $y)
        );
    ...
    {
        $this->client->sendCommand(
            (new Phue_Command_SetLightState($this))->colorTemp((int) $value)
        );
