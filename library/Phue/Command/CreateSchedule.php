 ...
 */
class Phue_Command_CreateSchedule implements Phue_Command_CommandInterface
{
    /**
     * Schedule attributes
     *
    ...
    public function __construct(
        $name = null,
        $time = null,
        Phue_Command_SchedulableInterface $command = null
    ) {
     ...
     * @return CreateSchedule Self object
     */
    public function command(Phue_Command_SchedulableInterface $command)
    {
