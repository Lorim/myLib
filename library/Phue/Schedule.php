...
class Phue_Schedule
{
    ...
    public function setName($name)
    {
        $this->client->sendCommand(
            (new Phue_Command_SetScheduleAttributes($this))->name((string) $name)
        );
    ...
    {
        $this->client->sendCommand(
            (new Phue_Command_SetScheduleAttributes($this))->description((string) $description)
        );
    ...
    {
        // Init command
        $command = new Phue_Command_SetScheduleAttributes($this);
     ...
     * @return Schedule Self object
     */
    public function setCommand(Phue_Command_SchedulableInterface $command)
    {
        $this->client->sendCommand(
            (new Phue_Command_SetScheduleAttributes($this))->command($command)
        );
    ...
    {
        $this->client->sendCommand(
            (new Phue_Command_DeleteSchedule($this))
        );
    }
