...
class Phue_Group
{
    ...
    public function setName($name)
    {
        $this->client->sendCommand(
            (new Phue_Command_SetGroupAttributes($this))->name((string) $name)
        );
    ...
    public function setLights(array $lights)
    {
        ...
        $this->client->sendCommand(
            (new Phue_Command_SetGroupAttributes($this))->lights($lightIds)
        );
    ...
    {
        $this->client->sendCommand(
            (new Phue_Command_SetGroupState($this))->on((bool) $flag)
        );
    ...
    {
        $this->client->sendCommand(
            (new Phue_Command_SetGroupState($this))->brightness((int) $level)
        );
    ...
    {
        $this->client->sendCommand(
            (new Phue_Command_SetGroupState($this))->hue((int) $value)
        );
    ...
    {
        $this->client->sendCommand(
            (new Phue_Command_SetGroupState($this))->saturation((int) $value)
        );
    ...
    {
        $this->client->sendCommand(
            (new Phue_Command_SetGroupState($this))->xy((float) $x, (float) $y)
        );
    ...
    {
        $this->client->sendCommand(
            (new Phue_Command_SetGroupState($this))->colorTemp((int) $value)
        );
     ...
     */
    public function setAlert($mode = Phue_Command_SetGroupState::ALERT_LONG_SELECT)
    {
        $this->client->sendCommand(
            (new Phue_Command_SetGroupState($this))->alert($mode)
        );
    ...
    {
        $this->client->sendCommand(
            (new Phue_Command_SetGroupState($this))->effect($mode)
        );
    ...
    {
        $this->client->sendCommand(
            (new Phue_Command_DeleteGroup($this))
        );
    }
